...
module VexiiRiscv (
  ...
  output wire          LsuCachelessPlugin_logic_bus_cmd_valid /* verilator public */ ,
  input  wire          LsuCachelessPlugin_logic_bus_cmd_ready /* verilator public */ ,
  output wire [0:0]    LsuCachelessPlugin_logic_bus_cmd_payload_id /* verilator public */ ,
  output wire          LsuCachelessPlugin_logic_bus_cmd_payload_write /* verilator public */ ,
  output wire [31:0]   LsuCachelessPlugin_logic_bus_cmd_payload_address /* verilator public */ ,
  output wire [31:0]   LsuCachelessPlugin_logic_bus_cmd_payload_data /* verilator public */ ,
  output wire [1:0]    LsuCachelessPlugin_logic_bus_cmd_payload_size /* verilator public */ ,
  output wire [3:0]    LsuCachelessPlugin_logic_bus_cmd_payload_mask /* verilator public */ ,
  output wire          LsuCachelessPlugin_logic_bus_cmd_payload_io /* verilator public */ ,
  output wire          LsuCachelessPlugin_logic_bus_cmd_payload_fromHart /* verilator public */ ,
  output wire [15:0]   LsuCachelessPlugin_logic_bus_cmd_payload_uopId /* verilator public */ ,
  input  wire          LsuCachelessPlugin_logic_bus_rsp_valid /* verilator public */ ,
  input  wire [0:0]    LsuCachelessPlugin_logic_bus_rsp_payload_id /* verilator public */ ,
  input  wire          LsuCachelessPlugin_logic_bus_rsp_payload_error /* verilator public */ ,
  input  wire [31:0]   LsuCachelessPlugin_logic_bus_rsp_payload_data /* verilator public */ ,
  input  wire          clk,
  input  wire          reset
);
  ...
  assign _zz_LsuCachelessPlugin_logic_onPma_port_rsp_io = (|{_zz_LsuCachelessPlugin_logic_onPma_port_rsp_fault,((LsuCachelessPlugin_pmaBuilder_addressBits & 32'h10000000) == 32'h0)});
  ...
  assign _zz_execute_ctrl1_down_SrcStageables_REVERT_lane0_1 = (|{_zz_execute_ctrl1_down_BYPASSED_AT_3_lane0,{((execute_lane0_logic_decoding_decodingBits & 32'h00002014) == 32'h00002010),((execute_lane0_logic_decoding_decodingBits & 32'h40000034) == 32'h40000030)}});
  ...
  assign _zz_execute_ctrl1_down_BYPASSED_AT_2_lane0_1 = (|{_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0_1,_zz_execute_ctrl1_down_lane0_logic_completions_onCtrl_0_ENABLE_lane0});
  assign _zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_2 = _zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_3[0];
  assign _zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_3 = (|{_zz_execute_ctrl1_down_BYPASSED_AT_3_lane0,_zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_1});
  ...
  assign _zz_FetchCachelessPlugin_logic_onPma_port_rsp_io = (|{_zz_FetchCachelessPlugin_logic_onPma_port_rsp_fault,((FetchCachelessPlugin_pmaBuilder_addressBits & 32'h10000000) == 32'h0)});
  ...
  assign _zz_CsrAccessPlugin_logic_fsm_readLogic_csrValue_7 = 32'h40000100;
  ...
  assign LsuCachelessPlugin_logic_onPma_port_rsp_fault = (! ((|{_zz_LsuCachelessPlugin_logic_onPma_port_rsp_fault,{((LsuCachelessPlugin_pmaBuilder_addressBits & 32'hf0000000) == 32'h10000000),((LsuCachelessPlugin_pmaBuilder_addressBits & 32'hfffff000) == 32'h00001000)}}) && (|LsuCachelessPlugin_pmaBuilder_onTransfers_0_hit)));
  ...
  assign when_ExecuteLanePlugin_l197 = execute_lane0_bypasser_integer_RS2_sel[0];
  ...
  assign when_ExecuteLanePlugin_l197_1 = execute_lane0_bypasser_integer_RS1_sel[0];
  ...
  assign _zz_execute_ctrl1_down_BYPASSED_AT_3_lane0 = ((execute_lane0_logic_decoding_decodingBits & 32'h00000040) == 32'h00000040);
  ...
  assign _zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_1 = ((execute_lane0_logic_decoding_decodingBits & 32'h00000010) == 32'h00000010);
  assign execute_ctrl1_down_lane0_IntFormatPlugin_logic_WIDTH_ID_lane0 = {(|{_zz_execute_ctrl1_down_BYPASSED_AT_3_lane0_1,_zz_execute_ctrl1_down_CsrAccessPlugin_CSR_MASK_lane0}),(|((execute_lane0_logic_decoding_decodingBits & 32'h00001010) == 32'h00001000))};
  ...
  assign FetchCachelessPlugin_logic_onPma_port_rsp_fault = (! ((|{_zz_FetchCachelessPlugin_logic_onPma_port_rsp_fault,{((FetchCachelessPlugin_pmaBuilder_addressBits & 32'hf0000000) == 32'h10000000),((FetchCachelessPlugin_pmaBuilder_addressBits & 32'hfffff000) == 32'h00001000)}}) && (|FetchCachelessPlugin_pmaBuilder_onTransfers_0_hit)));
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      `ifndef SYNTHESIS
        ...
        `else
          if(!(! ((execute_ctrl2_up_LANE_SEL_lane0 && execute_ctrl2_down_CsrAccessPlugin_SEL_lane0) && execute_lane0_ctrls_2_upIsCancel)) && $realtime != 0) begin
